...
function ConfirmedRide(props) {
  return (
    <div className=' flex flex-col justify-center items-center'>
        <h4 onClick={()=>props.setConfirmRidePanel(false)} className='absolute top-8 right-4'><i  className="ri-arrow-down-s-line"></i></h4>
        ...
        }  className='w-full p-2 mt-5 bg-green-600 text-white font-semibold rounded-lg'>Confirm</button>
        </div>
